...
public class EdiçãoFuncionario extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EdiçãoFuncionario frame = new EdiçãoFuncionario();
	...
	public EdiçãoFuncionario() {
		...
		btnAtualizar.setBounds(10, 292, 190, 23);
